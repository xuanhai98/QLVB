...
?>
<?php echo form_open_multipart('admin/congvanden/insert'); ?>
<div class="content-wrapper">
	<form action="<?php echo base_url() ?>admin/congvanden/insert.html" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
