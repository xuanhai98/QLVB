...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="breadcrumb">
			<a class="btn btn-primary btn-sm" href="<?php echo base_url()?>admin/congvandi/insert" role="button">
								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td style="width:200px">
												<?php echo $val['cv_notes'] ?>
											</td>
											<td class="text-center">
												<a href="<?php echo base_url() ?>admin/congvandi/status/<?php echo $val['id'] ?>">
											...
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/congvandi/update/<?php echo $val['id']?>" role = "button">
													<span class="glyphicon glyphicon-edit"></span>Sửa
												</a>
											</td>
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/congvandi/delete/<?php echo $val['id'] ?>" role = "button">
