...
<?php echo form_open_multipart('admin/congvandi/insert'); ?>
<div class="content-wrapper">
	<form action="<?php echo base_url() ?>admin/congvandi/insert.html" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
