<?php echo form_open_multipart('admin/congvandi/update/'.$row['id']); ?>
<?php  
...
<div class="content-wrapper">
	<form action="<?php echo base_url() ?>admin/congvandi/update.html" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
		<section class="content-header">
			<h1><i class="glyphicon glyphicon-cd"></i> Cập nhật công văn đi</h1>
