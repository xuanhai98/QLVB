	  ...
	  <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="<?php echo base_url() ?>admin/congvanden" class="small-box-footer">Danh sách công văn đến</a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url() ?>admin/congvandi" class="small-box-footer">Danh sách công văn đi</a>
          </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-2 col-xs-3">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php ?>admin/thongbao" class="small-box-footer">Thông báo</a>
          </div>
        </div>
		<div class="col-lg-2 col-xs-3">
          <!-- small box -->
