<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="glyphicon glyphicon-tasks"></i> Danh mục đơn vị</h1>
		<div class="breadcrumb">
			<a class="btn btn-primary btn-sm" href="<?php echo base_url()?>admin/donvi/insert" role="button">
								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/donvi/update/<?php echo $val['id']?>" role = "button">
													<span class="glyphicon glyphicon-edit"></span>Sửa
												</a>
											</td>
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/donvi/delete/<?php echo $val['id'] ?>" role = "button">
