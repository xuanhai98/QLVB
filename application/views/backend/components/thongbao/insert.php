...
<?php echo form_open_multipart('admin/thongbao/insert'); ?>
<div class="content-wrapper">
	<form action="<?php echo base_url() ?>admin/thongbao/insert.html" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
		<section class="content-header">
			<h1><i class="glyphicon glyphicon-cd"></i> Thêm thông báo mới </h1>
