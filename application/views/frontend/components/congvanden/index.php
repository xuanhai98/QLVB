...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="breadcrumb">
			<!-- <a class="btn btn-primary btn-sm" href="<?php echo base_url()?>congvanden/insert" role="button">
								...
								<table class="table table-hover table-bordered">
									<thead>
										<tr>
											...
											<th class="text-center" style="width:30px">Số CV</th>
											<th class="text-center" style="width:30px">inCV</th>
											<th class="text-center" style="width:30px">Ngày nhận</th>
											<th class="text-center" style="width:30px">Ngày p/h</th>	
											<th class="text-center" style="width:200px">Nội dung tóm tắt</th>
											<th class="text-center" style="width:80px">Người ký</th>
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td style="width:50px" class="text-center">
												...
												foreach($groupid as $val2):?>
												<?php $donvi=$this->Mdonvi->donvi_detail($val2);
														?>
													<span><font color="red"><?php echo $donvi['tendonvi'].' ';?></font></span>
												<?php endforeach;?>
												</td>
