<?php echo form_open_multipart('congvanden/insert'); ?>
<div class="content-wrapper">
	<form action="<?php echo base_url() ?>congvanden/insert.html" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
		<section class="content-header">
			<h1><i class="glyphicon glyphicon-cd"></i> Thêm công văn đến mới</h1>
			<div class="breadcrumb">
				<button type = "submit" class="btn btn-primary btn-sm">
					<span class="glyphicon glyphicon-floppy-save"></span>
					Lưu[Thêm]
				</button>
				<a class="btn btn-primary btn-sm" href="congvanden" role="button">
						...
						<div class="box-body">
							...
							<?php echo validation_errors(); ?>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="cv_incomeno" style="width:100%" placeholder="Số công văn">
									<div class="error" id="password_error"><?php echo form_error('name')?></div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<form>
										...
										<label>Ngày nhận</label>
											<input id="datepicker1" name="receivedate"/>
										</span>
