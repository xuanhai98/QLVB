<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="glyphicon glyphicon-cd"></i> Danh sách tìm kiếm công văn đến</h1>
								...
								<table class="table table-hover table-bordered">
									<thead>
										<tr>
											...
											<th class="text-center" style="width:40px">Số CV đến</th>
											...
											<th class="text-center" style="width:100px">Người ký</th>
											<th class="text-center" style="width:100px">Ghi chú</th>
